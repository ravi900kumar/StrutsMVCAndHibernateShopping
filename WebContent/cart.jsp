...
<div align="center">
<h1>Struts MVC And Hibernate Shopping Cart</h1>
<table border="2" >
<tr>
<th>Options</th>
<th >Id</th>
...
<tr>
<td><a href="${pageContext.request.contextPath}/delete?id=${pr.product.id }" >Remove</a></td>
<td>${pr.product.id }</td>
...
<a href="${pageContext.request.contextPath}/index">Shoping</a>  <br>
